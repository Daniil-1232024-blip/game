...
const operationButtons = null; // Since we don't have operation buttons in UI
    ...
    function showVictory() {
        clearTimer();
        const victoryReward = activeItems['item7'] ? 20 : 10;
        coins += victoryReward;
        localStorage.setItem('coins', coins);
        updateMenuCoins();
        feedbackEl.innerHTML = `<div style="font-size: 2rem; color: #2e7d32; font-weight: bold;">🎉 ПОБЕДА! 🎉<br>+${victoryReward} монет</div>`;
